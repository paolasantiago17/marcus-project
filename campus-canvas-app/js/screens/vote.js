  ...
  return `
    <div id="vote-card" style="border-radius:20px; overflow:hidden; background:#FFFFFF; box-shadow:0 18px 40px rgba(27,25,22,.13);">
      <div style="position:relative;">
        <div style="width:100%; aspect-ratio:1.42; ${photoStyle(img.photo)} display:block;"></div>
    ...
    <p style="margin:14px 0 0; text-align:center; font-size:12px; font-weight:300; color:#8C8375;">Swipe right to like, left to pass</p>
  `;
}
